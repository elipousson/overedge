test_that("is_sf and as_sf functions work", {
  ...
  checkmate::expect_class(as_sf(nc), "sf")
  checkmate::expect_class(as_sf(bbox), "sf")
  checkmate::expect_class(as_sfc(bbox), "sfc")
  checkmate::expect_class(as_bbox(bbox), "bbox")
  checkmate::expect_class(as_bbox(nc), "bbox")
  checkmate::expect_class(as_bbox(sfc), "bbox")
