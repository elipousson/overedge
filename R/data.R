...
#' \describe{
#'   \item{\code{series}}{Series, USGS, architectural, or engineering}
#'   \item{\code{standard}}{Standard or scale name}
#'   \item{\code{scale}}{Scale}
#'   \item{\code{actual_ft}}{Scale distance for 1 foot actual.}
#'   \item{\code{actual_ft_unit}}{Unit of scale for 1 foot actual.}
#'   \item{\code{scale_in}}{Actual distance for 1 inch scale.}
#'   \item{\code{scale_in_unit}}{Unit of actual distance for 1 inch (in) scale.}
#'   \item{\code{scale_in_accuracy}}{Accuracy of 1 in scale (approximate or exact)}
#'   \item{\code{scale_cm}}{Actual distance for 1 centimeter (cm) scale.}
#'   \item{\code{scale_cm_unit}}{character COLUMN_DESCRIPTION}
...
#'   \item{\code{series_status}}{Series status (some USGS map series are abandoned)}
#'}
"standard_scales"
