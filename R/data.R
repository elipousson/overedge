...
#'
#' The first three icon sources use open licenses.
#' [Maki](https://github.com/mapbox/maki/blob/main/LICENSE.txt) and
#' [Temaki](https://github.com/ideditor/temaki/blob/main/LICENSE.md) both use a
#' CC0 license. The Weather Underground Icons use an [MIT
