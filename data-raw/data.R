...
standard_scales <-
  tibble::tribble(
                               ~series,       ~standard,        ~scale, ~actual_ft, ~actual_ft_unit, ~scale_in, ~scale_in_unit, ~scale_in_accuracy, ~scale_cm, ~scale_cm_unit, ~scale_cm_accuracy,            ~size_latlon, ~size_latlon_unit,       ~area_approx, ~area_approx_unit, ~series_status,
              "Puerto Rico 7.5 minute",          "USGS",    "1:20,000",      6e-04,            "in",      1670,           "ft",      "approximate",       200,            "m",            "exact",     "7.5 by 7.5 minute",          "minute",         "7.10E+01",           "sq mi",             NA,
                          "7.5 minute",          "USGS",    "1:24,000",      5e-04,            "in",      2000,           "ft",            "exact",       240,            "m",            "exact",     "7.5 by 7.5 minute",          "minute",         "49 to 70",           "sq mi",             NA,
                          "7.5 minute",          "USGS",    "1:25,000",    0.00048,            "in",      2080,           "ft",      "approximate",       250,            "m",            "exact",     "7.5 by 7.5 minute",          "minute",         "49 to 70",           "sq mi",             NA,
                    "7.5 by 15 minute",          "USGS",    "1:25,000",    0.00048,            "in",      2080,           "ft",      "approximate",       250,            "m",            "exact",      "7.5 by 15 minute",          "minute",        "98 to 140",           "sq mi",             NA,
                  "USGS-DMA 15 minute",          "USGS",    "1:50,000",    0.00024,            "in",      4170,           "ft",      "approximate",       500,            "m",            "exact",       "15 by 15 minute",          "minute",       "197 to 282",           "sq mi",             NA,
                          "15 minute*",          "USGS",    "1:62,500",         NA,              NA,         1,           "mi",      "approximate",       625,            "m",            "exact",       "15 by 15 minute",          "minute",       "197 to 282",           "sq mi",    "abandoned",
                         "Alaska Maps",          "USGS",    "1:63,360",         NA,              NA,         1,           "mi",            "exact",       634,            "m",            "exact", "15 by 20 to 36 minute",          "minute",       "207 to 281",           "sq mi",             NA,
                         "County Maps",          "USGS",    "1:50,000",    0.00024,            "in",      4170,           "ft",      "approximate",       500,            "m",            "exact",           "County area",                NA,           "Varies",                NA,             NA,
                         "County Maps",          "USGS",   "1:100,000",         NA,              NA,       1.6,           "mi",      "approximate",         1,           "km",            "exact",           "County area",                NA,           "Varies",                NA,             NA,
                     "30 by 60 minute",          "USGS",   "1:100,000",         NA,              NA,       1.6,           "mi",      "approximate",         1,           "km",            "exact",       "30 by 60 minute",          "minute",   "1,568 to 2,240",           "sq mi",             NA,
                          "30 minute*",          "USGS",   "1:125,000",         NA,              NA,         2,           "mi",      "approximate",      1.25,           "km",            "exact",       "30 by 30 minute",          "minute",     "786 to 1,124",           "sq mi",    "abandoned",
  "1 degree by 2 degrees or 3 degrees",          "USGS",   "1:250,000",         NA,              NA,         4,           "mi",      "approximate",       2.5,           "km",            "exact",        "1° by 2° or 3°",          "degree",   "4,580 to 8,669",           "sq mi",             NA,
                          "State Maps",          "USGS",   "1:500,000",         NA,              NA,         8,           "mi",      "approximate",         5,           "km",            "exact",            "State area",                NA,           "Varies",                NA,             NA,
                          "State Maps",          "USGS", "1:1,000,000",         NA,              NA,        16,           "mi",      "approximate",        10,           "km",            "exact",            "State area",                NA,           "Varies",                NA,             NA,
                 "U.S. Sectional Maps",          "USGS", "1:2,000,000",         NA,              NA,        32,           "mi",      "approximate",        20,           "km",            "exact",          "State groups",                NA,           "Varies",                NA,             NA,
                     "Antarctica Maps",          "USGS",   "1:250,000",         NA,              NA,         4,           "mi",      "approximate",       2.5,           "km",            "exact",       "1° by 3° to 15°",          "degree",   "4,089 to 8,336",           "sq mi",             NA,
                     "Antarctica Maps",          "USGS",   "1:500,000",         NA,              NA,         8,           "mi",      "approximate",         5,           "km",            "exact",            "2° by 7.5°",          "degree", "28,174 to 30,462",           "sq mi",             NA,
